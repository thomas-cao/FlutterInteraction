...
import 'package:my_flutter/NFTGroups/NftHomePage.dart';
    ...
    return Container(
       ...
       child: Padding(
         ...
         child: Row(
           ...
           children: [
               _buildItem("item1", context),
               _buildItem("item2", context),
               _buildItem("item3", context),
               _buildItem("item4", context),
           ],
         ),
       ),
    );
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(context, 
               MaterialPageRoute(builder: (context) => NftHomePage()));
      },
       child: Column(
         children: [
